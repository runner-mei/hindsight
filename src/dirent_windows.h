 ...
 */
DLL_VARIABLE wDIR* wopendir(wchar_t const* name);
 ...
 */
DLL_VARIABLE int wclosedir(wDIR* dir);
 ...
 */
DLL_VARIABLE void wrewinddir(wDIR* dir);
 ...
 */
DLL_VARIABLE struct wdirent* wreaddir(wDIR* dir);
